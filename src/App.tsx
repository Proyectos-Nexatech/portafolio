...
import { ArrowUpRight, Github, Instagram, Linkedin, Twitter, LayoutGrid, ShieldCheck, Zap, Menu, X } from 'lucide-react';
    ...
    <div className="min-h-screen">
      ...
      <section id="contact" className="py-32 px-6">
        <div className="max-w-3xl mx-auto text-center">
          <span className="text-accent text-xs font-bold uppercase tracking-widest mb-4 block">Contacto</span>
          <h2 className="text-4xl md:text-6xl font-bold font-display mb-8">¿TIENES UN PROYECTO EN MENTE?</h2>
          <p className="text-zinc-400 text-lg mb-12">
            Estamos listos para llevar tus ideas al siguiente nivel. Hablemos sobre cómo podemos ayudarte.
          </p>
          <button className="btn-primary px-12 py-5 text-lg">Iniciar Conversación</button>
        </div>
      </section>
